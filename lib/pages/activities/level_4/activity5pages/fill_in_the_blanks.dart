...
class _FillInTheBlanksPageState extends State<FillInTheBlanksPage>
  ...
  void checkAnswer() {
    ...
    setState(() {
      ...
      if (answer == correct) {
        ...
        int timeLeftPerQ = remainingTime ~/ questions.length;
        int totalTimePerQ = totalTime ~/ questions.length;
        int bonus = ((timeLeftPerQ / totalTimePerQ) * perQScore).round();
        totalScore += bonus;
      } else {
        wrongAnswers++;
      }
  ...
  Widget build(BuildContext context) {
    ...
    final correct = current['answer']!.toLowerCase();
