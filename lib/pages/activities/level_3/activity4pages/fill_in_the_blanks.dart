...
class _FillInTheBlanksPageState extends State<FillInTheBlanksPage>
  ...
  final List<Map<String, String>> questions = [
    {"text": "The frog sat on a ___ leaf.", "answer": "green"},
    {"text": "It saw a ___ in the pond.", "answer": "fish"},
    {"text": "The frog jumped ___ the log.", "answer": "over"},
  ];
