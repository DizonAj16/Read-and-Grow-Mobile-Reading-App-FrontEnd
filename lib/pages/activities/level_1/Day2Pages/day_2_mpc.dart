...
class _Day2MultipleChoicePageState extends State<Day2MultipleChoicePage> {
  final List<Map<String, dynamic>> questions = [
    {
      'question': ' What does the first sentence tell about this text?',
      'options': [
    ...
    {
      'question': ' To which word can the suffix –ing be added?',
    ...
    {
      'question': ' Which word means once in a while?',
  ...
  Timer? timer;
  int maxTimePerQuestion = 75; // Increased to 75 seconds
  ...
  void resetQuiz() {
    setState(() {
      ...
      finished = false;
      totalScore = 0;
      _shuffleQuestionsAndOptions(); // Reshuffle on retry
    });
    startTimer();
  }
