...
class PenInstructionPage extends StatefulWidget {
  final VoidCallback onCompleted;

  const PenInstructionPage({super.key, required this.onCompleted});

  @override
  State<PenInstructionPage> createState() => PenInstructionPageState();
}

class PenInstructionPageState extends State<PenInstructionPage> {
