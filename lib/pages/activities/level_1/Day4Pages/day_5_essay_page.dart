...
class _DayFiveEssayPageState extends State<DayFiveEssayPage> {
  ...
  Future<void> _loadEssay() async {
    ...
    final savedText = prefs.getString('day5_essay') ?? '';
    _essayController.text = savedText;
  }
  ...
  Future<void> _submitEssay() async {
    ...
    // Save locally
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('day5_essay', text);

    setState(() {
      _confirmationMessage = "📝 Essay saved locally.";
    });
