...
class FrogInstructionPage extends StatefulWidget {
  final VoidCallback onCompleted;

  const FrogInstructionPage({super.key, required this.onCompleted});

  @override
  State<FrogInstructionPage> createState() => _FrogInstructionPageState();
}

class _FrogInstructionPageState extends State<FrogInstructionPage> {
