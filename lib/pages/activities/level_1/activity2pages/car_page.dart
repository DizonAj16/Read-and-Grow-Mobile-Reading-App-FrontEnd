...
class CatRatFamilyPage extends StatefulWidget {
  final VoidCallback? onCompleted;

  const CatRatFamilyPage({super.key, this.onCompleted});

  @override
  _CatRatFamilyPageState createState() => _CatRatFamilyPageState();
}

class _CatRatFamilyPageState extends State<CatRatFamilyPage> {
  bool _completed = false;
  int _highlightIndex = -1;
  final ScrollController _scrollController = ScrollController();

  final List<String> wordFamily = ['cat', 'rat', 'mat', 'ran', 'hat', 'sat'];

  final Map<String, String> wordImages = {
    'cat': 'assets/activity_images/cat.jpg',
    'rat': 'assets/activity_images/rat.jpg',
    'mat': 'assets/activity_images/mat.jpg',
    'ran': 'assets/activity_images/ran.jpg',
    'hat': 'assets/activity_images/hat.png',
    'sat': 'assets/activity_images/sat.png',
  };
            ...
            Column(
              children: [
                Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      "assets/activity_images/cat.png", // Replace with your actual banner
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
