...
class StudentAnswersPage extends StatefulWidget {
  ...
  @override
  State<StudentAnswersPage> createState() => _StudentAnswersPageState();
}
...
class _StudentAnswersPageState extends State<StudentAnswersPage> {
  ...
  int score = 0;
  int maxScore = 0;
  String quizTitle = "Student Answers Review";
  ...
  Future<void> _loadStudentAnswers() async {
    ...
    try {
      debugPrint("\n===============================");
      debugPrint("➡️ STARTING STUDENT ANSWERS LOAD");
      debugPrint("===============================\n");
      ...
      questions =
          (questionsRes as List).map((q) {
            ...
            if (type == "multiple_choice_with_images" ||
              ...
              // In your JSON data, matching_pairs contains both correct answers and user selections
              debugPrint(
              ...
              if (userAnswer.isNotEmpty &&
                ...
                if (matchingPairsData is List) {
                  ...
                  // Clear the existing matchingPairs from database and use the ones from quiz_answers
                  matchingPairs.clear();
              ...
              // User should have selected the correct item for each left_item
  ...
  Widget _buildMultipleChoiceWithImagesSection(Map<String, dynamic> q) {
    ...
    for (int i = 0; i < options.length; i++) {
      ...
      debugPrint(
        "🎨 Option $i: text='${option['option_text']}', image='${option['option_image_url']}', correct=${option['is_correct']}",
      );
    }
    ...
    debugPrint("🎨 Found correct option: ${correctOption?['option_text']}");
    debugPrint("🎨 Found selected option: ${selectedOption?['option_text']}");
              ...
              Wrap(
                ...
                children:
                    options.map((option) {
                      ...
                      debugPrint(
                        "🟦 Rendering option: '$optionText' with image: '$optionImage'",
                      );
  ...
  Widget _buildOptionCard({
    ...
    debugPrint("🟦   Is student answer: $isStudentAnswer");
    debugPrint("🟦   Is correct: $isCorrect");
  ...
  Widget _buildSmallOptionCard({
    ...
    debugPrint("🟦 Building Small Option Card:");
    debugPrint("🟦   Text: '$text'");
    debugPrint("🟦   Image URL: '$imageUrl'");
    debugPrint("🟦   Is correct: $isCorrect");
            ...
            ClipRRect(
              ...
              child: Container(
                ...
                child: Image.network(
                  ...
                  errorBuilder: (context, error, stackTrace) {
                    debugPrint("❌ Small image load error for URL: $imageUrl");
                    return Center(
                      child: Icon(
                        Icons.broken_image,
                        color: Colors.grey,
  ...
  Widget _buildMatchingSection(Map<String, dynamic> q) {
    ...
    debugPrint("\n🔗 BUILDING MATCHING SECTION");
    debugPrint("🔗 Total pairs: ${matchingPairs.length}");
    debugPrint("🔗 User selections: ${userMatchingSelections.length}");
    debugPrint("🔗 Is correct: $isCorrect");
                ...
                Column(
                  children:
                      userMatchingSelections.map((selection) {
                        ...
                        debugPrint(
                          "🔗 Rendering selection: $leftItem -> $userSelected (correct: $isSelectionCorrect)",
                        );
  ...
  Widget _buildQuestionItem(int index, Map<String, dynamic> q) {
    final type = q['type'];
