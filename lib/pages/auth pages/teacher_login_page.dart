  ...
  Future<void> login() async {
    ...
    try {
      final result = await SupabaseAuthService.login(
        emailController.text.trim(), // Now using email
  ...
  Widget _buildHeader(BuildContext context) => Column(
    children: [
      ...
      Container(
        ...
        child: Text(
          "Welcome back! Sign in to manage your classes and students",
          style: TextStyle(
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(
                Icons.email, // Changed from account_circle to email icon
                color: Theme.of(context).colorScheme.onSurface,
              ),
          ...
          // Additional help text for email format
          const SizedBox(height: 20),
          Container(
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    "Example: juandelacruz@gmail.com\nContact your administrator if you forgot your email.",
                    style: TextStyle(
                      fontSize: 12,
                      color: Theme.of(context).colorScheme.onSurface.withOpacity(0.7),
                    ),
